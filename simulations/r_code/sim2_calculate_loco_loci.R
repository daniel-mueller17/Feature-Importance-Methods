...
data = read.csv("./simulations/data/sim2_data.csv")
data$X = NULL
...
loss = msr("regr.mse")
learner = lrn("regr.rsm", modelfun = "TWI")
...
write.csv(df_loco_loci, file = "./simulations/data/sim2_df_res_loco_loci.csv", row.names = FALSE)
